...
ChangeFontSize:
	If A_thishotkey~="i)up$"
		FontSize++
	else If A_thishotkey~="i)down$"
		FontSize--
	WubiIni.TipStyle["FontSize"]:=FontSize, WubiIni.save()
	Gosub srf_tooltip_cut
Return
