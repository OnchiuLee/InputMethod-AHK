...
;常用的符号列表（供选择用）
SymObiect:={A:[["中文逗号", "，"], ["中文句号", "。"],["中文问号", "？"],["中文感叹号", "！"],["中文冒号", "："],["中文分号", "；"],["中文顿号", "、"],["水平省略号", "…"],["波浪线", "~"],["连接符", "&"],["邮箱符", "@"],["数字标记", "#"]]
	,B:[["英文逗号", ","],["英文句号", "."],["英文问号", "?"],["英文感叹号", "!"],["英文冒号", ":"],["英文分号", "`;"],["省略号", "……"],["全角波浪线", "～"],["全角连接符", "＆"],["全角邮箱符", "＠"],["全角数字标记", "＃"],["点", "·"]]
	,C:[["中文双引号", "“”"],["中文单引号", "‘’"],["中文双引号" ,"〝〞"],["英文半角双引号" ,""""],["英文半角单引号" ,"''"],["英文全角双引号" ,"＂"],["英文全角号" ,"＇"],["半角撇号" ,"´"],["全角撇号" ,"＇"]]
	,D:[["中文圆括号", "（）"],["实心括号", "【】"],["中文书名号", "《》"],["全角尖括号", "＜＞"],["半角龟壳型括号", "﹝﹞"],["英文尖括号", "<>"]]
	,E:[["英文圆括号", "()"],["英文方括号", "`[`]"],["双尖括号", "«»"],["尖括号", "‹›"],["全角龟壳型括号", "〔〕"],["单书名号", "〈〉"]]
	,F:[["大括号", "`{`}"],["全角方括号", "［］"],["角括号", "「」"],["全角花括号", "｛｝"],["空心括号", "〖〗"],["空心角括号", "『』"]]
	,G:[["垂直上圆括号", "︵"],["垂直上花括号", "︷"],["垂直上龟壳型括号", "︹"],["垂直上尖括号", "︿"],["垂直上双尖括号", "︽"],["垂直上角括号", "﹁"],["垂直上空心角括号", "﹃"],["垂直上实心括号", "︻"],["垂直上空心括号", "︗"],["斜线", "/"],["竖线", "|"],["反斜线", "\"]]
;	,H:[["垂直下圆括号", "︶"],["垂直下花括号", "︸"],["垂直下龟壳型括号", "︺"],["垂直下尖括号", "﹀"],["垂直下双尖括号", "︾"],["垂直下角括号", "﹂"],["垂直下空心角括号", "﹄"],["垂直下实心括号", "︼"],["垂直下空心括号", "︘"],["全角斜线", "／"],["全角竖线", "｜"],["全角反斜线", "＼"]]
;	,I:[["下横线", "_"],["全角下横线", "＿"],["波浪下横线", "﹏"],["虚线下横线", "﹍"],["中心线下横线", "﹎"],["抑音符", "``"],["间段条", "¦"],["倒感叹号", "¡"],["扬抑符", "^"],["连字符", "­"],["分音符", "¨"],["锐音符", "ˊ"]]
	,J:[["全角上横线", "¯"],["全角上横线", "￣"],["波浪上横线", "﹋"],["虚线上横线", "﹉"],["中心线上横线", "﹊"],["全角抑音符", "ˋ"],["波形竖线", "︴"],["倒问号", "¿"],["抑扬符", "ˇ"]]}
...
WM_MOUSEMOVE()
{
	global Logo_X, Logo_Y, SrfTip_Width, SrfTip_Height, Logo_ExStyle, transparentX, LogoSize, Tip_Show:={LineColor:"Gdip样式中间分隔线颜色",SBA6:"符号顶首选屏并上屏该键符号",font_value:"候选字号大小`n范围[9-40]"
		...
		, SBA4:"加入开机自启动任务：「`non＝>为建立系统计划任务实现自启`noff＝>为关闭开机自启`nsc＝>为在系统自启目录建立快捷方式实现自启」",ciku6:"特殊符号词库导出`n（导出为txt）",set_GdipRadius:"Gdip候选框圆角大小`n范围[0-15]"
		...
		,sethotkey_2:"打开小键盘选取键值",InputStatus:"窗口程序输入状态配置，只对新开窗口有效！",set_SizeValue:"桌面色块尺寸`n范围[1-150]", vset_regulate:"ToolTip候选框编码框`n与选词框距离范围[3-25]"
